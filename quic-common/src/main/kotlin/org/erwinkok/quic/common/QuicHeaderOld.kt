...
class QuicHeaderOld private constructor(
    ...
    override fun toString(): String {
        return "version=$version, type=$type, scid=$scid, dcid=$dcid, token=[${
            token.toHexString(
                HexFormat {
                    bytes {
                        bytesPerGroup = 1
    ...
    companion object Companion {
        ...
        fun parse(inputSegment: MemorySegment): QuicHeaderOld {
            ...
            try {
                ...
                return QuicHeaderOld(arena, outputSegment)
            } catch (e: Exception) {
                arena.close()
                throw e
            }
